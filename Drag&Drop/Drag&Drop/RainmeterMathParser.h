...
//Straight copy from https://github.com/rainmeter/rainmeter
//Used to parse the option values, which is for some strange reason not possible in the RainmeterAPI 
